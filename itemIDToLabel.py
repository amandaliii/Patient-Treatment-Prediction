...
def load_itemid_label_mappings_excel(d_items_path, d_labitems_path, cache_file="idlabel_map.xlsx"):
    ...
    Uses Excel for caching instead of pickle.
    """
    ...
    # 2. Otherwise, read CSVs directly
    ...
    # 3. Merge — D_LABITEMS overwrites D_ITEMS where ITEMID matches

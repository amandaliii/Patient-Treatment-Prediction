...
2. itemIDToLabel - maps itemIDs to their labels string format
3. buildModel - the LSTM model
4. trainModel - trains the model using precision, accuracy, recall, and f1 score
